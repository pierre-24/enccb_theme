...
This theme is a subtheme of [`stable`](https://www.drupal.org/docs/8/theming-drupal-8/using-classy-as-a-base-theme).
...
+ To remove comment, remove the comment field in any content types of `Admin > Structure > Content types`.
